...
const SingleProductHero = () => {
  ...
  const product = {
    ...
    description: "French bread loaf with a crisp outer crust, chewy texture and a soft crumb. Perfect accompaniment for soups & salads.",
    allergens: "Wheat, Soy",
    storage: [
    ...
    reviews: [
      { id: 1, user: "Sarah J.", rating: 5, text: "Perfect crust! Reminds me of Paris." },
      { id: 2, user: "Mike T.", rating: 4, text: "Great taste, but best eaten fresh same day." }
    ]
  };
              ...
              <div className="tab-content">
                ...
                {activeTab === 'description' && (
                  <div className="content-pane fade-in">
                    ...
                    <p className="meta-info"><strong>Allergens:</strong> {product.allergens}</p>
                  </div>
                )}
